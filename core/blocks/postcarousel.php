			...
			'attributes' => array(
				...
				*		Post Design
				...
				'contentPadding' 	=> array(
					...
					'default' 	=> (object) array(),
					'style' 	=> [(object) [
						'selector' => '{{QUBELY}} .qubely-post-grid-content'
					]]
				),
				'bgColor' 	=> array(
					'type' 		=> 'object',
				...
				'border' 		=> array(
					...
					'default' 	=> (object) array(),
					'style' 	=> [(object) [
						'selector' => '{{QUBELY}} .qubely-post-grid-wrapper'
					]]
				),
				'borderRadius' 	=> array(
					'type' 		=> 'object',
					'default' 	=> (object) array(),
					'style' 	=> [(object) [
						'selector' => '{{QUBELY}} .qubely-postgrid-style-1 .qubely-post-grid-wrapper, {{QUBELY}} .qubely-postgrid-style-2 .qubely-post-grid-wrapper, {{QUBELY}} .qubely-post-grid-view.qubely-postgrid-style-3 .qubely-post-grid-content'
					]]
				),
				'boxShadow' 	=> array(
					'type' 			=> 'object',
					...
					'style' => [
						(object) [
							'selector' => '{{QUBELY}} .qubely-postgrid-style-2 .qubely-post-grid-wrapper.qubely-post-grid-center, {{QUBELY}} .qubely-post-grid-view.qubely-postgrid-style-3 .qubely-post-grid-content'
						]
					]
				),
				//card
				...
				'cardSpace' => array(
					...
					'style' => [
						(object) [
							'condition' => [(object) ['key' => 'style', 'relation' => '==', 'value' => 2]],
							'selector' => '{{QUBELY}} .qubely-carousel-item.qubely-post-grid-view.qubely-postgrid-style-2 {padding: {{cardSpace}};}'
						]
					]
				),
				'cardPadding' => array(
				...
				'categoryTypography' => array(
					...
					'default' 	=> (object) [
						...
						'family' 	=> "Roboto",
						'type' 		=> "sans-serif",
						'size' 		=> (object) ['md' => 12, 'unit' => 'px'], 'spacing' => (object) ['md' => 1.1, 'unit' => 'px'], 'transform' => 'capitalize'
					],
					'style' 	=> [(object) [
...
function render_block_qubely_postcarousel_pro($att)
{
	...
	if ($query->have_posts()) { 
		...
		$html .= '<div class="qubely-carousel-extended-outer-stage" style="transition: all 0s ease 0s;">';
		...
		$html .= '</div>'; # qubely-carousel-extended-outer-stage
		$html .= '</div>'; # qubely-carousel-extended-list
