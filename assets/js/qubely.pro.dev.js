				...
				return React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement('span', { className: 'dashicons dashicons-dismiss' })
						)
					),
					React.createElement(
						'div',
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						...
						layout != 6 && layout != 1 && layout != 2 && React.createElement(Toggle, { label: __('Slider Content'), value: sliderContent, onChange: function onChange(value) {
