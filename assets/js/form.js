...
jQuery(document).ready(function ($) {
    ...
    if ($('.qubely-form-timepicker').length > 0) {

        const timePickers = $('.qubely-form-timepicker')
        let indexOfTimePicker = 0
        while (indexOfTimePicker < timePickers.length) {
            let currentTimePicker = timePickers[indexOfTimePicker]
            var tpicker = new timepicker(currentTimePicker, args)
