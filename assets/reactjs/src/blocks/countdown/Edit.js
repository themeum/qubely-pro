...
const { PanelBody, CheckboxControl, TimePicker, DatePicker, TextControl, Dropdown, Toolbar, DateTimePicker } =
	wp.components;

const { BlockControls, InspectorControls, AlignmentToolbar } = wp.blockEditor;
							...
							<PanelBody opened={true}>
								...
								<div className="qubely-countdown-control-date-picker">
									<Dropdown
										...
										renderContent={() => (
											<div
												className="qubely-countdown-control-dropdown"
												style={{ display: "flex" }}
											>
												<DateTimePicker
													currentDate={date}
									...
									<ButtonGroup
										...
										options={[
											[
												<img
													src={
														qubely_pro_admin.plugin + "assets/img/blocks/countdown/ban.svg"
													}
													alt={__("None")}
												/>,
												"none",
											...
											[
												<img
													src={
														qubely_pro_admin.plugin +
														"assets/img/blocks/countdown/colon.svg"
													}
													alt={__("Colon")}
												/>,
												"colon",
											...
											[
												<img
													src={
														qubely_pro_admin.plugin + "assets/img/blocks/countdown/pipe.svg"
													}
													alt={__("Pipe")}
												/>,
												"line",
										...
										value={
											layout === 2 || justifyAlign === "space-between" ? "none" : separatorType
										}
