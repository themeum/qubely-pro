		...
		pricelistContents: {
			...
			default: [
				...
				},
				{
					...
					discount: "$15",
					description:
						"Qubely has a rich library of ready sections that can be imported and used as blocks on the Gutenberg.",
				},
				{
					...
					price: "$40.00",
					discount: "$25",
					description: "Get a rich collection of blocks that are highly customizable and easy to use.",
				},
				{
					title: "Layout Packs",
					digitText: "04",
					...
					discount: "$35",
					description:
						"Qubely gives you many beautiful template layouts completely free of cost. These can also customize.",
				},
			],
		},
			...
			style: [
				{
					...
					selector:
						"{{QUBELY}} .qubely-block-pricelist.qubely-pricelist-item-1 {border-style: solid; border-width: {{contentBorderWidth}};}",
				},
				{
					condition: [
					...
					selector:
						"{{QUBELY}} .qubely-pricelist-item-2 .qubely-pricelist-content {border-style: solid; border-width: {{contentBorderWidth}};}",
				},
			],
		},
		contentBorderColor: {
			...
			style: [
				{
					...
					selector:
						"{{QUBELY}} .qubely-block-pricelist.qubely-pricelist-item-1 {border-color: {{contentBorderColor}};}",
				},
				{
					condition: [
						{ key: "style", relation: "===", value: "2" },
					...
					selector:
						"{{QUBELY}} .qubely-pricelist-item-2 .qubely-pricelist-content {border-color: {{contentBorderColor}};}",
				},
			],
		},
		contentBg: {
			...
			style: [
				{
					...
					selector:
						"{{QUBELY}} .qubely-block-pricelist.qubely-pricelist-item-3 .qubely-pricelist-content, {{QUBELY}} .qubely-block-pricelist.qubely-pricelist-item-3 .qubely-pricelist-image-container .qubely-empty-image {height: {{height}};}",
				},
			],
		},
		contentSpacing: {
		...
		contentPadding: {
			...
			style: [
				...
				},
				{
					...
					selector:
						"{{QUBELY}} .qubely-pricelist-item-3 .qubely-pricelist-content .qubely-pricelist-description",
				},
			],
		},
		contentBorderRadius: {
			...
			style: [
				{
					...
					selector:
						"{{QUBELY}} .qubely-pricelist-image-container .qubely-pricelist-badge {left: auto; right: 15px;}",
				},
			],
		},
		badgeTypography: {
			...
			style: [
				{
					...
					selector:
						"{{QUBELY}} .qubely-pricelist-digit {text-align:center; width: {{digitSize}};} {{QUBELY}} .qubely-pricelist-digit {height: {{digitSize}};} {{QUBELY}} .qubely-pricelist-digit {line-height: {{digitSize}};}",
				},
			],
		},
		digitBorderRadius: {
		...
		digitSpacing: {
			...
			style: [
				...
				},
				{
					...
					selector:
						"{{QUBELY}} .qubely-block-pricelist .qubely-pricelist-item .qubely-pricelist-digit {margin-right: {{digitSpacing}};}",
				},
				{
					condition: [
						{ key: "enableMedia", relation: "==", value: true },
					...
					selector:
						"{{QUBELY}} .qubely-block-pricelist .qubely-pricelist-item .qubely-pricelist-digit {margin-bottom: {{digitSpacing}};}",
				},
			],
		},
