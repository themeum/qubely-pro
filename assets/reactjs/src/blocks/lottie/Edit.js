...
const {
    ...
    withCSSGenerator,
    gloalSettings: {
        globalSettingsPanel, animationSettings, interactionSettings },
...
class Edit extends Component {
    ...
    loadLottieAnimation (){
        const {  attributes: { lottieFileExternal } } = this.props;
        if (this.animation) {
        ...
        this.animation = lottie.loadAnimation({
            ...
            loop: true,
            autoplay: true,
            path: lottieFileExternal != '' ? lottieFileExternal : 'https://assets9.lottiefiles.com/packages/lf20_e4wr20hj.json',
        });
    }
