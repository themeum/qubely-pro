...
function Edit(props) {
	...
	const wrappeprClasses = classnames(
		"qubely_woo_products_wrapper",
						...
						<PanelBody title={__("Product Card")} initialOpen={false}>
							...
							{(layout === 1 || (layout === 2 && style === 3)) && (
								<ButtonGroup
									...
									onChange={(value) =>
										setAttributes(
											layout === 1 ? { contentPosition: value } : { girdContentPosition: value }
										)
									}
								/>
							)}
							...
							{style !== 3 && (
								<Fragment>
									<Padding
										...
										onChange={(val) =>
											setAttributes(
												layout === 1 ? { infoPadding: val } : { gridInfoPadding: val }
											)
										}
										onDeviceChange={(value) => setDevice(value)}
									/>
							...
							{style === 3 && (
								<Fragment>
									...
									<Range
										...
										onChange={(value) =>
											setAttributes(
												layout === 1 ? { stackWidth: value } : { gridStackWidth: value }
											)
										}
									/>
									{layout === 1 && (
									...
									<div className="qubely_woo_product">
										...
										<div className="qubely-product-info">
											{showRatings && (
												<div className="qubely-product-ratings-wrapper">
													<div
														...
														style={{ "--qubely-product-rating": `${average_rating * 20}%` }}
													/>
											...
											{on_sale ? (
												...
												<div className="qubely-product-price qubely-regular-price">
													${price}
												</div>
											)}
