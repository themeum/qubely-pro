		...
		style: [
			{
				...
				// ],
				selector:
					"{{QUBELY}} .qubely-block-btn-wrapper:not(.button-type-outline) .qubely-block-btn-anchor:before",
			},
		],
	},
...
const attributes = {
	...
	stripeColor: {
		...
		style: [
			{
				condition: [{ key: "layout", relation: "==", value: "row-stripe" }],
				selector:
					"{{QUBELY}} .qubely-block-table.row-stripe table tr:not(.head-row):nth-child(odd){background: {{stripeColor}};}",
			},
			{
				condition: [{ key: "layout", relation: "==", value: "column-stripe" }],
				selector:
					"{{QUBELY}} .qubely-block-table.column-stripe tr td:nth-child(odd){background: {{stripeColor}};}",
			},
		],
	},
	headerBg: {
		...
		style: [
			{
				selector:
					"{{QUBELY}} .qubely-block-table .qubely-table-figure .qubely-table thead tr.head-row th.qubely-block-table_cell-content",
			},
		],
	},
	headerTextColor: {
	...
	headerBorder: {
		...
		style: [
			{
				selector:
					"{{QUBELY}} .qubely-block-table thead {border-bottom: {{headerBorder}};border-bottom-style: solid;}",
			},
		],
	},
	headerBorderColor: {
		...
		style: [
			{
				selector:
					"{{QUBELY}} .qubely-block-table thead {border-bottom-color: {{headerBorderColor}} !important;}",
			},
		],
	},
	headerTypo: {
		type: "object",
		default: {},
		style: [{ selector: "{{QUBELY}} .qubely-block-table thead .head-row .qubely-block-table_cell-content" }],
	},
	tableFooter: {
		type: "boolean",
		default: false,
	...
	tableBoxShadow: {
		...
		style: [{ selector: "{{QUBELY}} .qubely-block-table table:not(.no-outer-border)" }],
	},
	tableBorderRadius: {
		type: "object",
		default: {},
	...
	footerBg: {
		type: "object",
		default: {},
		style: [{ selector: "{{QUBELY}} .qubely-block-table tfoot" }],
	},
	footerTextColor: {
		type: "string",
		default: "#000",
	...
	footerTypo: {
		type: "object",
		default: {},
		style: [{ selector: "{{QUBELY}} .qubely-block-table tfoot .foot-row .qubely-block-table_cell-content" }],
	},
	tableMaxWdith: {
		type: "object",
		default: {},
		style: [{ selector: "{{QUBELY}} .qubely-block-table {width: {{tableMaxWdith}};}" }],
	},
	fixedWithCells: {
		type: "boolean",
		default: true,
	...
	cellBg: {
		type: "object",
		default: {},
		style: [{ selector: "{{QUBELY}} .qubely-block-table .qubely-block-table_cell-content" }],
	},
	cellTypography: {
		type: "object",
		default: {},
	...
	cellAlignment: {
		...
		style: [
			{
				selector:
					"{{QUBELY}} .qubely-block-table .qubely-block-table_cell-content {text-align: {{cellAlignment}}; }",
			},
		],
	},
	cellVerticalPosition: {
		...
		style: [
			{
				selector:
					"{{QUBELY}} .qubely-block-table .qubely-block-table_cell-content {vertical-align: {{cellVerticalPosition}}; }",
			},
		],
	},
	cellBorder: {
	...
	ratingsAlignment: {
		...
		style: [{ selector: "{{QUBELY}} .ratings-cell.ratings-wrapper {text-align: {{ratingsAlignment}};}" }],
	},
	ratingsPadding: {
		type: "object",
		default: {},
		style: [{ selector: "{{QUBELY}} .ratings-cell.ratings-wrapper" }],
	},
	...
	imageAlignment: {
		...
		style: [{ selector: "{{QUBELY}} .image-cell.image-wrapper {text-align: {{imageAlignment}};}" }],
	},
	imageCommonSize: {
		type: "string",
		default: "100px",
	...
	imagePadding: {
		type: "object",
		default: {},
		style: [{ selector: "{{QUBELY}} .image-cell.image-wrapper" }],
	},
	imageRadius: {
		type: "object",
		default: {},
		style: [{ selector: "{{QUBELY}} .image-cell.image-wrapper .qubely-image" }],
	},
	...
	iconPadding: {
		type: "object",
		default: {},
		style: [{ selector: "{{QUBELY}} .icon-cell.icon-wrapper .icon i" }],
	},
	iconBg: {
		type: "object",
		default: {},
	...
	iconRadius: {
		type: "String",
		default: "",
		style: [{ selector: "{{QUBELY}} .icon-cell.icon-wrapper .icon i{border-radius:{{iconRadius}}%};" }],
	},
	iconAlignment: {
		type: "object",
		default: {
		...
		style: [{ selector: "{{QUBELY}} .icon-cell.icon-wrapper {text-align: {{iconAlignment}};}" }],
	},
	iconSize: {
		type: "string",
		default: "40px",
	...
	listColor: {
		...
		style: [
			{
				selector:
					"{{QUBELY}} .qubely-block-table .qubely-table-figure .qubely-table .qubely-block-table_cell-content .list-cell.list-wrapper {color: {{listColor}};}",
			},
		],
	},
	listIcon: {
	...
	listAlignment: {
		...
		style: [{ selector: "{{QUBELY}} .list-cell.list-wrapper {text-align: {{listAlignment}};}" }],
	},
	listPadding: {
		type: "object",
		default: {},
		style: [{ selector: "{{QUBELY}} .list-cell.list-wrapper" }],
	},
