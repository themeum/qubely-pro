                        ...
                        <div className={`qubely-block-form ${interactionClass} qubely-layout-${layout}`}>
                            <form className={`qubely-form is-${inputSize}`}>
                                ...
                                <div className="qubely-form-button" >
                                    ...
                                    <input type="hidden" name="field-error-message" value={_encrypt(fieldErrorMessage)} />
                                    <input type="hidden" name="form-success-message" value={_encrypt(formSuccessMessage)} />
                                    <input type="hidden" name="form-error-message" value={_encrypt('Email sending failed, something went wrong! Please try again.')} />
                                    <input type="hidden" name="recaptcha" value={(reCaptcha && reCaptchaSiteKey && reCaptchaSecretKey) ? 'true' : 'false'} />
                                    <input type="hidden" name="recaptcha-site-key" value={reCaptchaSiteKey} />
                                    <input type="hidden" name="recaptcha-secret-key" value={reCaptchaSecretKey} />
                                    <input type="hidden" name="email-receiver" value={_encrypt(emailReceiver)} />
                                    <input type="hidden" name="email-headers" value={_encrypt('Reply-To: {{email}}\nReply-name: {{text-11}} {{text-12}}\nCc: {{email}}\nBcc: admin@yourcompany.com')} />
                                    <input type="hidden" name="email-from" value={_encrypt('Your Company Name: admin@qubely.io')} />
                                    <input type="hidden" name="email-subject" value={_encrypt('{{text-31}} | {{email-21}} | {{site-name}}')} />
                                    <input type="hidden" name="email-body" value={_encrypt('<p><strong>From:</strong> {{text-11}} {{text-12}}</p><strong>Email:</strong> {{email-21}}</p>\n<p><strong>Subject:</strong> {{text-31}}</p>\n<p><strong>Message:</strong> {{textarea-41}}</p>')} />
                                </div>
                        ...
                        <div className={`qubely-block-form ${interactionClass} qubely-layout-${layout}`}>
                            <form className={`qubely-form is-${inputSize}`}>
                                ...
                                <div className="qubely-form-button" >
                                    ...
                                    <input type="hidden" name="email-receiver" value={_encrypt(emailReceiver)} />
                                    <input type="hidden" name="email-headers" value={_encrypt('Reply-To: {{email}}\nReply-name: {{text-11}} {{text-12}}\nCc: {{email}}\nBcc: admin@yourcompany.com')} />
                                    <input type="hidden" name="email-from" value={_encrypt('Your Company Name: admin@your_sitename.com')} />
                                    <input type="hidden" name="email-subject" value={_encrypt('{{text-31}} | {{email-21}} | {{site-name}}')} />
                                    <input type="hidden" name="email-body" value={_encrypt('<p><strong>From:</strong> {{text-11}} {{text-12}}</p><strong>Email:</strong> {{email-21}}</p>\n<p><strong>Subject:</strong> {{text-31}}</p>\n<p><strong>Message:</strong> {{textarea-41}}</p>')} />
                                </div>
