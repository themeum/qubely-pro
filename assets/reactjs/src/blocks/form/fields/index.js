...
const qubelyFormFields = [
	...
	//4. textarea
	{
		...
		settings: {
			...
			icon: (
				<img src={qubely_pro_admin.plugin + "assets/img/blocks/form/textarea.svg"} alt={__("Textarea field")} />
			),
			attributes: {
				...qubelyField.settings.attributes,
				fieldName: {
	...
	// 5. dropdown
	{
		...
		settings: {
			...
			icon: (
				<img src={qubely_pro_admin.plugin + "assets/img/blocks/form/dropdown.svg"} alt={__("Dropdown field")} />
			),
			attributes: {
				...qubelyField.settings.attributes,
				fieldName: {
	...
	// 7. checkbox
	{
		...
		settings: {
			...
			icon: (
				<img src={qubely_pro_admin.plugin + "assets/img/blocks/form/checkbox.svg"} alt={__("Checkbox field")} />
			),
			attributes: {
				...qubelyField.settings.attributes,
				fieldName: {
