	...
	return (
		<Fragment>
			...
			<PanelBody title={__("Label")} initialOpen={false}>
				<Typography value={labelTypography} onChange={(val) => updateAttributes("labelTypography", val)} />
				<Range
					min={0}
					max={100}
					responsive
				...
				/>
				<Color label={__("Color")} value={labelColor} onChange={(val) => updateAttributes("labelColor", val)} />
			</PanelBody>
			...
			<PanelBody title={__("Input")} initialOpen={false}>
				...
				<Border
					...
					onChange={(value) =>
						layout === "classic"
							? updateAttributes("inputBorder", value)
							: updateAttributes("inputBorderMaterial", value)
					}
				/>
				...
				<Tabs>
					<Tab tabTitle={__("Normal")}>
						<Color
							...
							value={inputColor}
							onChange={(val) => updateAttributes("inputColor", val)}
						/>
						<Color
							label={__("Background Color")}
							value={inputBg}
							onChange={(val) => updateAttributes("inputBg", val)}
						/>
						<Color
							label={__("Placeholder Color")}
							value={placeholderColor}
							onChange={(val) => updateAttributes("placeholderColor", val)}
						/>
					</Tab>
					<Tab tabTitle={__("Focus")}>
						<Color
							...
							onChange={(val) => updateAttributes("inputColorFocus", val)}
						/>
						<Color
							label={__("Background Color")}
							value={inputBgFocus}
							onChange={(val) => updateAttributes("inputBgFocus", val)}
						/>
						<Color
							label={__("Border Color")}
							value={inputBorderColorFocus}
							onChange={(value) => updateAttributes("inputBorderColorFocus", value)}
						/>
						<Color
							label={__("Placeholder Color")}
							value={placeholderColorFocus}
							onChange={(val) => updateAttributes("placeholderColorFocus", val)}
						/>
					</Tab>
					<Tab tabTitle={__("Hover")}>
						<Color
							...
							onChange={(val) => updateAttributes("inputColorHover", val)}
						/>
						<Color
							label={__("Background Color")}
							value={inputBgHover}
							onChange={(val) => updateAttributes("inputBgHover", val)}
						/>
						<Color
							label={__("Border Color")}
							value={inputBorderColorHover}
							onChange={(value) => updateAttributes("inputBorderColorHover", value)}
						/>
						<Color
							label={__("Placeholder Color")}
							value={placeholderColorHover}
							onChange={(val) => updateAttributes("placeholderColorHover", val)}
						/>
					</Tab>
				</Tabs>
				...
				<Tabs>
					<Tab tabTitle={__("Form")}>
						...
						<Toggle
							...
							onChange={(val) => updateAttributes("policyCheckbox", val)}
						/>
						<Toggle
							label={__("Enable reCAPTCHA")}
							value={reCaptcha}
							onChange={(val) => updateAttributes("reCaptcha", val)}
						/>
						...
						{reCaptcha && (
							<div>
								...
								<span className="qubely-recaptcha-help">
									...
									<a href="//www.google.com/recaptcha/admin/">
