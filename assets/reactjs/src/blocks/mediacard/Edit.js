        ...
        return (
            <Fragment>
                                ...
                                <PanelBody title={__('Card Settings')} initialOpen={false}>
                                    ...
                                    {((layout == '1') || (layout == '2') || (layout == '3') || (layout == '6') || (layout == '7')) &&
                                        <Fragment>
                                            ...
                                            <BorderRadius label={__('Corner')} value={cardBgBorderRadius} onChange={(value) => setAttributes({ cardBgBorderRadius: value })} min={0} max={100} unit={['px', 'em', '%']} responsive device={device} onDeviceChange={value => this.setState({ device: value })} />
                                            ...
                                            <BoxShadow label={__('Shadow')} value={cardBgShadow} onChange={(value) => setAttributes({ cardBgShadow: value })} />
                                        </Fragment>
                                    }
                ...
                <div className={`qubely-block-${uniqueId}${className ? ` ${className}` : ''}`}>
                    <div
                        className={`qubely-block-mediacard qubely-mediacard-layout-${layout} ${(imagePosition != '') ? 'qubely-mediacard-image-position-' + imagePosition : ''} ${(imagePositionHorizontal != '') ? 'qubely-mediacard-image-position-' + imagePositionHorizontal : ''}`}
