								...
								{style === 4 && (
									<Fragment>
										...
										<Range
											...
											value={overlaySmallHeight}
											onChange={(value) => setAttributes({ overlaySmallHeight: value })}
											unit={["px", "em", "%"]}
											min={50}
											max={700}
											responsive
							...
							<PanelBody title={__("Image Settings")} initialOpen={false}>
								...
								{style != 4 && (
									<Fragment>
										...
										{enableFixedHeight && (layout === 5 || layout === 3) && (
											<Range
												label={__("Small Image")}
												value={fixedSmallHeight}
												onChange={(value) => setAttributes({ fixedSmallHeight: value })}
												unit={["px", "em", "%"]}
												min={10}
												max={400}
												responsive
							...
							<PanelBody title={__("Spacing")} initialOpen={false}>
								...
								{((layout != 1 && style === 1) || style === 2) && (
									<Range
										label={__("Image")}
										value={imageSpace}
										onChange={(value) => setAttributes({ imageSpace: value })}
										unit={["px", "em", "%"]}
										min={0}
										max={100}
										responsive
