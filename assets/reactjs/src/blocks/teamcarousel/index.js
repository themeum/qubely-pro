	...
	attributes: {
		...
		alignment: {
			...
			style: [
				{
					selector:
						"{{QUBELY}} .qubely-team-author-info {text-align: {{alignment}};} {{QUBELY}} .qubely-team-author {text-align: {{alignment}};}",
				},
			],
		},
		spacer: {
		...
		* 			Slider Settings 			
		...
		horizontalScroll: {
			...
			style: [
				{
					selector:
						"{{QUBELY}} .qubely-carousel.qubely-carousel-wrapper .qubely-carousel-nav-control .nav-control.prev-control { left: {{horizontalScroll}} } {{QUBELY}} .qubely-carousel.qubely-carousel-wrapper .qubely-carousel-nav-control .nav-control.next-control { right: {{horizontalScroll}} }",
				},
			],
		},
		arrowPosition: {
			...
			style: [
				{
					selector:
						"{{QUBELY}} .qubely-carousel.qubely-carousel-wrapper .qubely-carousel-nav-control { top: {{arrowPosition}}; } ",
				},
			],
		},
		dotsPosition: {
			...
			style: [
				{
					selector:
						"{{QUBELY}} .qubely-carousel.qubely-carousel-wrapper .qubely-carousel-dots { bottom: {{dotsPosition}}; } ",
				},
			],
		},
		cornerRadius: {
			...
			style: [
				{
					selector:
						"{{QUBELY}} .qubely-carousel-nav-control .nav-control { border-radius: {{cornerRadius}}; } ",
				},
			],
		},
		cornerHoverRadius: {
		...
		arrowSize: {
			...
			style: [
				{
					selector:
						"{{QUBELY}} .qubely-carousel-nav-control .nav-control .fas { font-size: {{arrowSize}}; } ",
				},
			],
		},
		// Section Arrow
		...
		dotColor: {
			...
			style: [
				{
					selector:
						"{{QUBELY}} .qubely-block-team-carousel  .qubely-carousel.qubely-carousel-wrapper .qubely-carousel-dots ul li:not(.active)",
				},
			],
		},
		// Dot Active Color
		...
		nameColor: {
			type: "string",
			default: "",
			style: [{ selector: "{{QUBELY}} .qubely-team-author-name { color:{{nameColor}}; }" }],
		},
		nameTypo: {
			type: "object",
			default: { openTypography: 1, weight: 700, size: { md: 16, unit: "px" } },
			style: [{ selector: "{{QUBELY}} .qubely-team-author-name" }],
		},
		nameSpacing: {
			type: "object",
			default: {},
			style: [{ selector: "{{QUBELY}} .qubely-team-author-name {margin-bottom: {{nameSpacing}};}" }],
		},
		...
		designationColor: {
			type: "string",
			default: "",
			style: [{ selector: "{{QUBELY}} .qubely-team-author-designation { color:{{designationColor}}; }" }],
		},
		designationTypo: {
			type: "object",
			default: { openTypography: 1, size: { md: 14, unit: "px" } },
			style: [{ selector: "{{QUBELY}} .qubely-team-author-designation" }],
		},
		designationSpacing: {
			type: "object",
			default: {},
			style: [
				{ selector: "{{QUBELY}} .qubely-team-author-designation {margin-bottom: {{designationSpacing}};}" },
			],
		},
			...
			style: [
				{
					...
					selector:
						"{{QUBELY}} .qubely-block-team-carousel .qubely-single-img {width: {{avatarWidth}};} {{QUBELY}} .qubely-block-team-carousel .qubely-single-img .qubely-team-avatar {width: 100%;}",
				},
				{
					condition: [
						{ key: "avatarSize", relation: "==", value: "custom" },
			...
			style: [
				{
					condition: [{ key: "avatarSize", relation: "==", value: "custom" }],
					selector:
						"{{QUBELY}} .qubely-block-team-carousel .qubely-single-img .qubely-team-avatar {object-fit: cover; height:{{avatarHeight}};}",
				},
			],
		},
			...
			style: [
				{
					...
					selector:
						"{{QUBELY}} .qubely-block-team-carousel .qubely-team-avatar {margin-bottom: {{avatarVerticalSpacing}}; }",
				},
			],
		},
			...
			style: [
				{
					...
					selector:
						"{{QUBELY}} .qubely-block-team-carousel .qubely-single-img {margin-right: {{avatarHorizontalSpacing}}; }",
				},
			],
		},
		avatarBorderRadius: {
		...
		textColor: {
			type: "string",
			default: "",
			style: [{ selector: "{{QUBELY}} .qubely-team-author-info { color:{{textColor}}; }" }],
		},
		// Background Color
		bgColor: {
			type: "string",
			...
			style: [
				...
				},
				{
					condition: [{ key: "layout", relation: "==", value: "3" }],
					selector:
						"{{QUBELY}} .qubely-team-3 {background-color: {{bgColor}};} {{QUBELY}} .qubely-team-info-layout-3 .qubely-team-carousel-content-wrapper:before {border-color: {{bgColor}} transparent transparent transparent;}",
				},
			],
		},
		...
		bgPadding: {
			...
			style: [
				...
				},
				{
					condition: [{ key: "layout", relation: "==", value: "2" }],
					selector:
						"{{QUBELY}} .qubely-layout-2 .qubely-tesitmonial-item, {{QUBELY}} .qubely-team-2 .qubely-team-author-info",
				},
				{
					condition: [{ key: "layout", relation: "==", value: "3" }],
			...
			style: [
				{
					condition: [{ key: "layout", relation: "==", value: "3" }],
					selector:
						"{{QUBELY}} .qubely-team-author-info .qubely-team-info-layout-3 {margin-top: {{contentSpacing}};}",
				},
			],
		},
		// Border radius
		...
		border: {
			...
			default: {
				openTy: 0,
				color: "#3373dc",
				width: { bottom: "1", left: "1", right: "1", top: "1", unit: "px" },
			},
			style: [{ selector: "{{QUBELY}} .qubely-team-carousel-item" }],
		},
		boxShadow: {
